...
const fieldClass = "h-10 min-w-0 rounded-lg border border-gray-200 bg-white px-3 text-sm text-gray-600 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20";
...
export default function LeaveApprovalFilters({ filters, leaveTypes, onChange, onReset }: Props) {
  return <section className="grid min-w-0 grid-cols-1 gap-3 rounded-xl border border-gray-200 bg-white p-4 shadow-sm sm:grid-cols-2 lg:grid-cols-3 lg:p-5 xl:grid-cols-[1fr_1fr_1fr_1fr_1.6fr_auto] xl:items-end">
